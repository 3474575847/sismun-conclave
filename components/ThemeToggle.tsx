...
export default function ThemeToggle() {
    ...
    return (
        <button
            ...
            className="p-2 rounded-full transition-all duration-300 flex items-center justify-center bg-white/10 hover:bg-white/20 border border-white/20 shadow-lg hover:scale-110 active:scale-95"
