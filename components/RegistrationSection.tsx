...
export default function RegistrationSection() {
    ...
    return (
        <section
            ...
            className="relative bg-charcoal dark:bg-charcoal text-platinum dark:text-white py-32 px-8 z-20 overflow-hidden transition-colors duration-500"
        >
            <div className="max-w-4xl mx-auto w-full">
                    ...
                    <div className="relative p-1 bg-charcoal/5 dark:bg-white/5 border border-charcoal/10 dark:border-white/10 rounded-full flex gap-1 mb-6">
                        <button
                            ...
                            className={`px-8 py-3 rounded-full text-[10px] font-mono uppercase tracking-[0.2em] transition-all duration-500 relative z-10 ${
                                regType === 'school' ? 'text-white dark:text-charcoal' : 'text-platinum/40 dark:text-platinum/40 hover:text-platinum dark:hover:text-white'
                            }`}
                        >
                            School Delegations
                        </button>
                        <button
                            ...
                            className={`px-8 py-3 rounded-full text-[10px] font-mono uppercase tracking-[0.2em] transition-all duration-500 relative z-10 ${
                                regType === 'independent' ? 'text-white dark:text-charcoal' : 'text-platinum/40 dark:text-platinum/40 hover:text-platinum dark:hover:text-white'
                            }`}
                        >
                ...
                <div className="reg-content-fade min-h-[600px]">
                    {regType === 'school' ? (
                        <div className="space-y-24 text-platinum/80 dark:text-platinum/80 font-light text-lg leading-relaxed transition-colors duration-500">
                            {/* School Delegations Content */}
                            <div>
                                <div className="mb-12 reg-text">
                                    <h2 className="text-4xl md:text-5xl font-serif font-bold text-platinum dark:text-platinum leading-tight mb-4 uppercase tracking-tighter transition-colors duration-500">
                                ...
                                <div className="space-y-10">
                                    ...
                                    <div className="reg-text">
                                        <h3 className="text-xl font-display font-bold text-platinum dark:text-platinum mb-2 uppercase tracking-wide transition-colors duration-500">Step 1: Expression of Interest</h3>
                                        <ul className="list-none space-y-3 pl-2">
                                            ...
                                            <li className="flex gap-4">
                                                <span className="text-gold font-mono">—</span>
                                                <span className="text-platinum/60 dark:text-platinum/60 transition-colors duration-500">Deadline: <span className="font-semibold">8th July 2026</span></span>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    {/* Step 2 */}
                                    <div className="reg-text">
                                        <h3 className="text-xl font-display font-bold text-platinum dark:text-white mb-2 uppercase tracking-wide transition-colors duration-500">Step 2: Submission of Delegate Details and Registration Fees</h3>
                                        <ul className="list-none space-y-3 pl-2">
                                            <li className="flex gap-4">
                                                <span className="text-gold font-mono">—</span>
                                            ...
                                            <li className="flex gap-4">
                                                <span className="text-gold font-mono">—</span>
                                                <span className="text-platinum/60 dark:text-platinum/60 transition-colors duration-500">Deadline: <span className="font-semibold">10th July 2026</span></span>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    {/* Payment Details */}
                                    <div className="reg-text">
                                        <h3 className="text-xl font-display font-bold text-platinum dark:text-platinum mb-2 transition-colors duration-500">Payment Details</h3>
                                    ...
                                    <div className="reg-text mt-20 mb-12 p-8 bg-charcoal/5 dark:bg-platinum/5 border-l-4 border-gold rounded-r-xl transition-colors duration-500">
                                        ...
                                        <p className="mt-3 text-platinum/60 dark:text-platinum/60 text-base transition-colors duration-500">For detailed guidelines regarding independent delegate registration, kindly refer to the Independent Delegates tab above.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
