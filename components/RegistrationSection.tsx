                                ...
                                <div className="space-y-10">
                                    <div className="reg-text">
                                        ...
                                        <ul className="list-none space-y-3 pl-2">
                                            ...
                                            <li className="flex gap-4">
                                                <span className="text-gold font-mono">—</span>
                                                <span className="text-white/60">Deadline: 20th June 2026</span>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div className="reg-text">
                                        ...
                                        <ul className="list-none space-y-3 pl-2">
                                            ...
                                            <li className="flex gap-4">
                                                <span className="text-gold font-mono">—</span>
                                                <span className="text-white/60">Deadline: 25th June 2026</span>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div className="reg-text">
                                        ...
                                        <ul className="list-none space-y-3 pl-2">
                                            ...
                                            <li className="flex gap-4">
                                                <span className="text-gold font-mono">—</span>
                                                <span className="text-white/60">Payment Deadline: 30th June 2026</span>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div className="space-y-10">
                                    <div className="reg-text">
                                        <ul className="list-none space-y-4 pl-2">
                                            ...
                                            <li className="flex gap-4">
                                                <span className="text-gold font-mono">—</span>
                                                <span className="text-white/60">Deadline: 30th June 2026</span>
                                            </li>
                                        </ul>
                                    </div>
