...
export const committees: Committee[] = [
    {
        name: 'General Assembly 4: Special Political and Decolonisation Committee',
        acronym: 'GA4',
        slug: 'ga4',
        ...
        studentOfficers: [
            ...
            { name: 'Yug Banerjjee', role: 'Deputy President', email: 'yugzgaming@gmail.com', image: '/team-photos/Yug.jpg' }
        ],
        detailedWriteup: {
    ...
    },
    {
        ...
        studentOfficers: [
            ...
            { name: 'Yidam Verma', role: 'Deputy President', email: 'yidamverma00@gmail.com', image: '/team-photos/Yidam.jpg' }
        ],
        detailedWriteup: {
            ...
            body: [
                ...
                "Our second agenda: “Addressing the humanitarian crisis and threats to international peace and security, resulting from the Yemen conflict through the formation of an independent task force monitored by UN”, demands action on a tragedy which has lasted for over a decade now. This conflict has been responsible for 377,00 deaths (Friends Committee on National Legislation, 2023) and 4.5 million Yemeni people (around 14% of the population) displaced from their homes (UNHCR, 2025). The Red Sea crisis which began in late 2023 threatens the 12% of global trade which passes through the Suez Canal.",
    ...
    },
    {
        ...
        studentOfficers: [
            ...
            { name: 'Anya Narayan', role: 'Deputy President', email: 'reachanyanarayan@gmail.com', image: '/team-photos/Aanya.jpg' }
        ],
        detailedWriteup: {
    ...
    },
    {
        ...
        studentOfficers: [
            ...
            { name: 'Diva Meharchandani', role: 'Deputy President', email: 'diva.meharchandani@gmail.com', image: '/team-photos/Diva.jpg' }
        ],
        detailedWriteup: {
    ...
    },
    {
        ...
        studentOfficers: [
            ...
            { name: 'Rithvik Singh', role: 'Deputy President', email: 'rithvik.rahul.singh@gmail.com', image: '/team-photos/Rithvik.jpg' }
        ],
        detailedWriteup: {
            ...
            body: [
                ...
                "Our second agenda: “Proposed formation of a future independent government with the prevalent Situation in East Pakistan” explores the Pakistani unification’s breaking point. Following the central government’s perceived negligence during the 1970 Bhola Cyclone and the subsequent refusal to honor the Awami League’s landslide victory, the social contract in the East has vanished. Freeze Date: 3rd December, 1971."
            ],
            bibliography: [
    ...
    },
    {
        ...
        topics: [
            ...
            'The question of granting Greenland conditional autonomy from the Kingdom of Denmark with regards to use of their own resources and a step towards nationhood.'
        ],
        ...
        detailedWriteup: {
            ...
            body: [
                ...
                "Our second agenda item, \"The question of granting Greenland conditional autonomy from the Kingdom of Denmark with regards to use of their own resources and a step towards nationhood.\" Since 2009, Greenland has been governed under a system of self-government. Facing climate change opening new shipping routes, interest in Arctic resources has intensified."
            ],
            bibliography: [
    ...
    },
    {
        ...
        detailedWriteup: {
            ...
            body: [
                "Our first agenda: \"The question of the Judicial Rights, privileges and Accountability for the Prisoners of Consciences taken from the Rohingya Population in Myanmar,\" calls delegates to confront one of the most long lasting crises. The Rohingya, a muslim minority in Myanmar have been discriminated against since the beginning of time.",
                "Our second agenda: “Setting up Truth and Reconciliation tribunal for Accountability of Crimes Against Humanity During the ongoing and still unfolding Venezuelan Political Crisis,” puts delegates in the middle of criminal accountability, transitional justice and the use of administrative measures to suppress opposing parties."
            ],
            bibliography: [
    ...
    },
    {
        ...
        studentOfficers: [
            { name: 'Krishiv Agarwal', role: 'President', email: 'krishivagarwal29@gmail.com', image: '/team-photos/Krishiv.jpg' },
            { name: 'Anushka Iyer', role: 'Deputy President', email: 'nushkaiyer0104@gmail.com', image: '/team-photos/Anushka.jpg' },
            { name: 'Yatharth Bhati', role: 'Deputy President', email: 'yatharthbhatiecole@gmail.com', image: '/team-photos/Yatharth.jpg' }
        ],
        detailedWriteup: {
